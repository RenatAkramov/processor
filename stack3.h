...
typedef double StackElem_t; // void*
#define DEBUG
...
void stackCheck(Stack_t* stk, Hash_struct* hash); // static

int compare(StackElem_t a, StackElem_t b); // static

unsigned long long hash_func_array(Stack_t* stk);// static

unsigned long long hash_func_struct(Stack_t* stk);// static
